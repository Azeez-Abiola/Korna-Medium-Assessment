...
const TopSection = styled.div`
  ...
  @media (max-width: 768px) {
    padding: 0 16px; /* Match layout padding */
  }
`;
...
const IconButton = styled.button`
  ...
  @media (max-width: 768px) {
    display: none; /* Hide notification icon on mobile */
  }
`;
...
const NavigationBorder = styled.div`
  position: absolute;
  bottom: 0;
  left: 20px; /* Match layout padding */
  max-width: 680px; /* Match ArticleContainer max-width exactly */
  width: 100%;
  height: 1px;
  background-color: #f2f2f2; /* Match article border color exactly */
  
  @media (max-width: 768px) {
    left: 16px; /* Match mobile layout padding */
    max-width: none;
    width: calc(100% - 32px); /* Account for mobile padding on both sides */
  }
`;
...
const NavLink = styled.a`
  ...
  align-items: center;
  position: relative;
  color: ${props => props.active ? '#000' : '#6b6b6b'};
    ...
    <>
      <HeaderContainer>
        <TopSection>
          <LeftSection>
            <HamburgerMenuButton onClick={toggleMenu}>
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                <path fill="currentColor" d="M20.6 17.51a.5.5 0 0 1 0 .98l-.1.01h-17a.5.5 0 0 1 0-1h17zm0-6a.5.5 0 0 1 0 .98l-.1.01h-17a.5.5 0 0 1 0-1h17zm0-6a.5.5 0 0 1 0 .98l-.1.01h-17a.5.5 0 0 1 0-1h17z"/>
              </svg>
            </HamburgerMenuButton>
          <Logo>
            <svg xmlns="http://www.w3.org/2000/svg" width="719" height="160" fill="none" aria-labelledby="wordmark-medium-desc" viewBox="0 0 719 160">
          ...
          <SearchContainer>
            <SearchIcon xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
